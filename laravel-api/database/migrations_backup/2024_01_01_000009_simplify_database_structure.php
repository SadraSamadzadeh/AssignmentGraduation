    ...
    public function up(): void
    {
        ...
        Schema::table('global_matches', function (Blueprint $table) use ($driver) {
            ...
            if ($driver !== 'sqlite') {
                ...
                // For SQLite, manually drop indexes first
                DB::statement('DROP INDEX IF EXISTS global_matches_match_score_index');
                DB::statement('DROP INDEX IF EXISTS global_matches_verified_by_user_id_index');
            }
        ...
        Schema::table('tracking_dashboard', function (Blueprint $table) use ($driver) {
            ...
            if ($driver !== 'sqlite') {
                ...
                // For SQLite, manually drop indexes first
                DB::statement('DROP INDEX IF EXISTS tracking_dashboard_status_index');
                DB::statement('DROP INDEX IF EXISTS tracking_dashboard_priority_index');
            }
        ...
        Schema::table('video_dashboard', function (Blueprint $table) use ($driver) {
            // For SQLite, we need to skip dropping columns with foreign keys
            ...
            // For SQLite, skip this migration - tables will be correct on fresh install
        });
    }
